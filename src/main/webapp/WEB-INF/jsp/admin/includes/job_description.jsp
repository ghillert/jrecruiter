<%@ include file="/WEB-INF/jsp/includes/taglibs.jsp"%>
    <fieldset style="clear: left;">
        ...
        <div class="required">
           ...
           <s:textarea name="model.job.description" id="description" rows="15" tabindex="21" cssStyle="width: 500px"/>
        </div>
        <div class="optional">
           <label for="jobRestrictions"><spring:message code="jsp._ALL.job.field.jobRestrictions" /></label>
           <s:textarea name="model.job.jobRestrictions" id="jobRestrictions" rows="10" tabindex="22" cssStyle="width: 500px"/>
