...
<s:form id="addUserForm" action="addJob">
	...
	<div class="required">
	   <label for="businessLocation"><fmt:message key="field.location" /></label>
	   <s:textfield name="businessLocation" id="businessLocation" size="11" tabindex="3"
	                onfocus="javascript:this.className='selected';"
		            onblur="javascript:this.className='';" />
    </div>
    <div class="required">
	...
	<div class="required">
	   ...
	   <s:textfield name="industry" id="industry" size="11" tabindex="5"
             		onfocus="javascript:this.className='selected';"
		            onblur="javascript:this.className='';" />
    </div>
    <div class="required">
	...
	<div id="map"
		style="width: 500px; height: 300px; margin: 0 auto 0 auto; border: 1px solid black;"></div>
