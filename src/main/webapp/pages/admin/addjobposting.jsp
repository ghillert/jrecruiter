...
<div id="main">
  <h2><bean:message key="admin.add.job.title" /></h2>
  ...
  <table class="jobposting">
    <tr>
      <td><bean:message key="field.jobTitle" />*</td>
      <td>
      ...
      <td><bean:message key="field.businessName" />*</td>
    ...
    <tr>
      <td><bean:message key="field.location" /></td>
      ...
      <td><bean:message key="field.address" /></td>
    ...
    <tr>
      <td><bean:message key="field.industry" /></td>
    ...
    <tr>
      <td><bean:message key="field.salary" /></td>
      ...
      <td><bean:message key="field.city" /></td>
    ...
    <tr>
      ...
      <td><bean:message key="field.state" /></td>
    ...
    <tr>
      ...
      <td><bean:message key="field.zip" /></td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td><bean:message key="field.website" /></td>
    ...
    <tr>
      <td><bean:message key="field.jobDescription" />*</td>
    ...
    <tr>
      <td><bean:message key="field.jobRestrictions" /></td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td><html:submit><bean:message key="jobposting.button.add"/></html:submit> <html:cancel><bean:message key="jobposting.button.cancel"/></html:cancel></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp; </td>
      <td colspan="3"><bean:message key="jobposting.add.label.mandatory" /></td>
    </tr>
  </table>
  </html:form>
</div>