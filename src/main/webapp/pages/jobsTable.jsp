<%@include file="/taglibs.jsp"%>
    ...
    <ajax:displayTag id="displayTagFrame" ajaxFlag="displayAjax" baseUrl="${ctx}/showJobs.html" postFunction="h()">
        ...
        <display:column class="column1" property="jobTitle" titleKey="field.jobTitle" sortable="true" href="showJobs.html?action=details" paramId="id" paramProperty="id" media="html csv xml excel pdf" maxLength="30"/>
