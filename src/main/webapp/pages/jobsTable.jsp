<%@include file="/taglibs.jsp"%>
    ...
    <ajax:displayTag id="displayTagFrame" ajaxFlag="displayAjax" baseUrl="${ctx}/showJobs.do" postFunction="h()">
        ...
        <display:column class="column1" property="jobTitle" titleKey="field.jobTitle" sortable="true" href="showJobDetail.do" paramId="id" paramProperty="id" media="html csv xml excel pdf" maxLength="30"/>
