...
public class DefaultNotificationServiceImpl implements NotificationService {
	...
	public void sendTweetToTwitter(final String tweet) {
		...
		if (apiKeysHolder.isTwitterEnabled()) {
			ConfigurationBuilder cb = new ConfigurationBuilder();
			cb.setDebugEnabled(true)
			  .setOAuthConsumerKey(apiKeysHolder.getTwitterConsumerKey())
			  .setOAuthConsumerSecret(apiKeysHolder.getTwitterConsumerSecret())
			  .setOAuthAccessToken(apiKeysHolder.getTwitterAccessToken())
			  .setOAuthAccessTokenSecret(apiKeysHolder.getTwitterAccessTokenSecret());
