...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.authorizeRequests().antMatchers("/s/admin/**").hasAnyAuthority("ADMIN").and()
		...
		.formLogin().loginProcessingUrl("/login.html").defaultSuccessUrl("/admin/index.html").loginPage("/login").failureUrl("/login.html?status=error").permitAll();
	}
